# FileCompareTool (Data Processing & Comparison Tool)

FileCompareTool is a Qt-based graphical application designed for processing, cleaning, and optimizing YOLO-format datasets.
